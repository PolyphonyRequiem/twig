...
**Parent:** #{{ intake.output.epic_id }} — {{ intake.output.epic_title }}
...
2. Set context to the parent: `twig set {{ intake.output.epic_id }} --output json`
...
5. Record the full ADO structure AND the PR group assignments
