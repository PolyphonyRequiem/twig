...
public sealed class ShowCommandTests : IDisposable
{
    ...
    public ShowCommandTests()
    {
        ...
        _syncCoordinatorPair = new SyncCoordinatorPair(_workItemRepo, adoService, protectedCacheWriter, pendingChangeStore, null, 30, 30);
    ...
    public async Task Show_MinimalDependencies_StillWorks()
    {
        ...
        SetupCachedItem(item);
        var cmd = new ShowCommand(_workItemRepo, _linkRepo, _formatterFactory, _syncCoordinatorPair, _config);
